...
<header class="dark">
        <div id="top">
            ...
            <form class="column registration" action="inc/singup.php" method="post">
            ...
            <input placeholder="repeat password" alt="repeat_pass" onkeyup="check_rep_password()" class="register_input" id="register_rep_password" name="password_rep" type="password">
            <button type="submit" class="register_input" id="register_submit">Submit</button>
            <p class="ling_reg"> У вас уже есть аккаунт? - <a href="index.php">войдите</a>! </p>
            <?php 
                if($_SESSION['message']){
